            ...
            <form class="form-horizontal" method="POST" @submit.prevent="onSubmit" @keydown="form.errors.clear($event.target.name)">
                ...
                <div class="field">
                    ...
                    <div class="control has-icons-left">
                        ...
                        <input v-model="form.email" id="email" type="email" class="input" v-bind:class="{ 'is-danger': form.errors.has('invalid_login') }" name="invalid_login" placeholder="john@smith.net" required> 
                    </div>
                </div>
                ...
                <div class="field">
                    ...
                    <div class="control has-icons-left">
                        ...
                        <input v-model="form.password" id="password" type="password" class="input" v-bind:class="{ 'is-danger': form.errors.has('invalid_login') }" name="invalid_login" required> 
                    </div>
                </div>
