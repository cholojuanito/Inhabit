    ...
    <div class="container has-top-margin">
            <div class="column is-6 is-offset-3">
                <div class="box">
                    <!-- Steps section -->
                    <div class="steps">
                        <div class="step-item is-primary" :class="[step === 1 ? 'is-active' : '', step > 1 ? 'is-completed' : '']">
                        ...
                        <div class="step-item is-primary" :class="[step === 2 ? 'is-active' : '', step > 2 ? 'is-completed' : '']">
                            <div class="step-marker">
                                <span class="icon">
                    ...
                    <form class="form-horizontal"  @keyup="stepOneErrorCheck">
                        ...
                        <div v-if="step === 1">
                            ...
                            <div class="field">
                                ...
                                <div class="control">
                                    <input ref="autocomplete" id="street_address" type="text" class="input" name="street_address" placeholder=""> 
                                    <strong class="help is-danger" v-if="form.errors.has('street_address')">Pleaes enter a valid address</strong>
                                </div>    
                            </div>                 
                            ...
                            <div class="field">
                                <div class="control">
                                    ...
                                    <div class="radio-wrapper">
                                        <input type="radio" id="apartment_id" name="Apartment" 
                                            v-model="form.rental_type" value="Apartment" :checked="form.rental_type === 'Apartment'">
                                        <label class="radio-label" for="apartment_id">Apartment</label>

                                        <input type="radio" id="studio_id" name="Studio"
                                            v-model="form.rental_type" value="Studio" :checked="form.rental_type === 'Studio'">
                                        <label class="radio-label" for="studio_id">Studio</label>

                                        <input type="radio" id="condo_id" name="Condo"
                                            v-model="form.rental_type" value="Condo" :checked="form.rental_type === 'Condo'">
                                        <label class="radio-label" for="condo_id">Condo</label>

                                        <input type="radio" id="sfh_id" name="Single Family Home"
                                            v-model="form.rental_type" value="Single Family Home" :checked="form.rental_type === 'Single Family Home'">
                                        <label class="radio-label" for="sfh_id">Single Family Home</label>

                                        <input type="radio" id="th_id" name="Townhome"
                                            v-model="form.rental_type" value="Townhome" :checked="form.rental_type === 'Townhome'">
                                    ...
                                    <div class="level">
                                        <div class="level-left">
                                            <div class="level-item">
                                                <span :class="this.form.num_beds <= 1 ? 'quantity-button-disabled' : 'quantity-button'" @click="decBed">
                                                    <span :class="this.form.num_beds <= 1 ? 'quantity-button-content-disabled' : 'quantity-button-content'">
                                                        <svg viewBox="0 0 24 24" role="img" aria-label="subtract bedrooms" focusable="false" style="height: 1em; width: 1em; display: block; fill: currentcolor;">
                                                            <rect height="2" rx="1" width="12" x="6" y="11"></rect>
                                                        </svg>
                                                    </span>
                                                </span>
                                                
                                                <input readonly class="quantity-input" type="number" id="num_beds" name="num_beds" v-model="form.num_beds">

                                                <span :class="this.form.num_beds >= 5 ? 'quantity-button-disabled' : 'quantity-button'" @click="incBed">
                                                    <span :class="this.form.num_beds >= 5 ? 'quantity-button-content-disabled' : 'quantity-button-content'">
                                                        <svg viewBox="0 0 24 24" role="img" aria-label="add bedrooms" focusable="false" style="height: 1em; width: 1em; display: block; fill: currentcolor;">
                            ...
                            <div class="field">
                                <div class="control">
                                    ...
                                    <div class="level">
                                        <div class="level-left">
                                            <span :class="this.form.num_baths <= 1 ? 'quantity-button-disabled' : 'quantity-button'" @click="decBath">
                                                <span :class="this.form.num_baths <= 1 ? 'quantity-button-content-disabled' : 'quantity-button-content'">
                                                    <svg viewBox="0 0 24 24" role="img" aria-label="subtract bathrooms" focusable="false" style="height: 1em; width: 1em; display: block; fill: currentcolor;">
                                                        <rect height="2" rx="1" width="12" x="6" y="11"></rect>
                                                    </svg>
                                                </span>
                                            </span>
                                            
                                            <input readonly class="quantity-input" type="number" id="num_baths" name="num_baths" v-model="form.num_baths">

                                            <span :class="this.form.num_baths >= 5 ? 'quantity-button-disabled' : 'quantity-button'" @click="incBath">
                                                <span :class="this.form.num_baths >= 5 ? 'quantity-button-content-disabled' : 'quantity-button-content'">
                                                    <svg viewBox="0 0 24 24" role="img" aria-label="add bathrooms" focusable="false" style="height: 1em; width: 1em; display: block; fill: currentcolor;">
                                                        <rect height="2" rx="1" width="12" x="6" y="11"></rect><rect height="12" rx="1" width="2" x="11" y="6"></rect>
                                                    </svg>
                                                </span>
                                            </span>
                            ...
                            <div class="field is-less-wide">
                                ...
                                <div class="control">
                                    <input type="number" class="input" id="square_ft" name="square_ft" v-model="form.square_ft" min="0">
                            ...
                            <div class="level">
                                ...
                                <div class="level-right">
                                    <div class="level-item">
                                        <div class="field">
                                            <div class="control">
                                                <input class="button is-primary" type="button" :value="nextText"  :disabled="stepOneNextBtnDisabled === 1" @click="next">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <form class="form-horizontal"  @keyup="stepTwoErrorCheck" @submit.prevent="onSubmit">
                            <div v-if="step === 2">
                                ...
                                <div class="field">
                                    ...
                                    <p class="help is-italizied">This is your chance to tell about your experience living here. Also include any info you think is relevant.</p>
                                ...
                                <div class="level">
                                    ...
                                    <div class="level-right">
                                        <div class="level-item">
                                            <div class="field">
                                                <div class="control">
                                                    <input type="submit" class="button is-primary" :value="nextText" :disabled="stepTwoNextBtnDisabled === 1">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="level">
                                    ...
                                    <div class="level-right">
                                        <div class="level-item">
                                            <div class="field">
                                                <div class="control">
                                                    <button class="button is-primary" type="button" @click="confirmPosted">
                                                        Post Listing
                                                    </button>
                                                </div>
                                            </div>
...
export default {
  ...
  methods: {
    ...
    confirmPosted() {
      this.showSuccess("Your listing has been saved. Others can now view it");
    },
    showSuccess(message) {
